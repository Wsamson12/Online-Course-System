...
<body>
    <nav>
        ...
        <div class="loginandregister">
            ...
            <a href="${pageContext.request.contextPath}/student/edit_profile?lang=en" style="color: white; text-decoration: none;">切換到英文</a>
        </div>
    </nav>
    ...
    <div class="container">
        <div class="card profile-card">
            ...
            <div class="card-body">
                <form action="<c:url value='/student/profile/update'/>" method="post">
                    <input type="hidden" name="${_csrf.parameterName}" value="${_csrf.token}"/>
                    ...
                    <button type="submit" class="btn btn-primary btn-custom">保存更改</button>
                    <c:url var="profileUrl" value="/student/profile"/>
                    <a href="${profileUrl}" class="btn btn-secondary btn-custom">取消</a>
                </form>
            </div>
        </div>
    </div>
