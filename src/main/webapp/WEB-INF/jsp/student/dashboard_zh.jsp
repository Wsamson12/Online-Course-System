...
<nav>
    ...
    <span class="header-text">歡迎, 學生 ${username}!</span>
    <div class="loginandregister">
        ...
        <a href="${pageContext.request.contextPath}/student/dashboard?lang=en" style="color: white; text-decoration: none;">切換到英文</a>    </div>
