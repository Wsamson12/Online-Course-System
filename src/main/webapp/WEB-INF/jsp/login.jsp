...
<style>
    ...
    * {
    ...
    <body>
        <div class="container">
            <div class="form--heading">Course Website <br/> User Login</div>
           ...
           <input name="submit" type="submit" value="Log In" /><br />
            ...
            <a href="${pageContext.request.contextPath}/login?lang=zh" style="color: white; text-decoration: none;">Change to Chinese</a>
