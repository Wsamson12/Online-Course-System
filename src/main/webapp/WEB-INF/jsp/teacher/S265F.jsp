    ...
    <div class="loginandregister">
       <span class="header-text">
            ...
            <form action="${logoutUrl}" method="post" style="display: inline;">
                ...
                <button type="submit" style="background: none; border: none; text-decoration: none; color: white; cursor: pointer;">Logout</button>
            </form>
        </span>
        <a href="${pageContext.request.contextPath}/teacher/S265F?lang=zh" style="color: white; text-decoration: none;">Change to Chinese</a>

    </div>
</nav>

<button class="add-file-button" onclick="openModal()">Add File</button>

<div class="container">
    <div class="box course-box">
        <div class="title">S265F Design And Analysis Of Algorithms (2025 Spring)</div>
        <p>Course details and information can go here.</p>
        <div class="file-list">
            <c:if test="${not empty files}">
                <c:forEach var="file" items="${files}">
                    <div class="file-list-item">
                        <strong>Title:</strong> ${file.title}<br>
                        <strong>File Name:</strong> <a href="${file.fileUrl}" download>${file.fileName}</a>
                        <form action="${pageContext.request.contextPath}/teacher/filedelete" method="post" style="display:inline;"> <!-- Updated action -->
    ...
    <div class="box comment-box">
        ...
        <div class="comment-area">
            <form action="${pageContext.request.contextPath}/teacher/S265F/submit_Comment" method="post">
                <textarea class="comment-input" name="comment" placeholder="Enter your comment here..."></textarea>
