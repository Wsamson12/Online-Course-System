...
<nav>
    ...
    <div class="loginandregister">
        ...
        <a href="${pageContext.request.contextPath}/teacher/edit_profile?lang=en" style="color: white; text-decoration: none;">切換到英文</a>
    ...
    <div class="card profile-card">
        ...
        <div class="card-body">
            <form action="<c:url value='/teacher/profile/update'/>" method="post">
                ...
                <button type="submit" class="btn btn-primary btn-custom">儲存更改</button>
                <c:url var="profileUrl" value="/teacher/profile"/>
