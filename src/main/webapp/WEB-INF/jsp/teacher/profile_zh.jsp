...
<nav>
    ...
    <div class="loginandregister">
        ...
        <a href="${pageContext.request.contextPath}/teacher/profile?lang=en" style="color: white; text-decoration: none;">切換到英文</a>
    ...
    <div class="card profile-card">
        ...
        <div class="card-body">
            ...
            <sec:authorize access="hasRole('TEACHER')">
                ...
                <a href="${editProfileUrl}" class="btn btn-outline-warning btn-custom">更改資料</a>
            </sec:authorize>
